...
function vw_one_page_admin_theme_style() {
   ...
   wp_enqueue_style('vw-one-page-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('vw-one-page-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_one_page_open_tab(event, 'one_lite')"><?php esc_html_e( 'Getting Started', 'vw-one-page' ); ?></button>		  
