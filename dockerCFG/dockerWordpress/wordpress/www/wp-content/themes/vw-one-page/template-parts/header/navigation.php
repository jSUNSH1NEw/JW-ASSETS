...
<div id="header" class="menubar">
  <div class="toggle-nav mobile-menu">
    <button onclick="vw_one_page_menu_open_nav()"><i class="<?php echo esc_attr(get_theme_mod('vw_one_page_res_open_menu_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','vw-one-page'); ?></span></button>
  </div> 
