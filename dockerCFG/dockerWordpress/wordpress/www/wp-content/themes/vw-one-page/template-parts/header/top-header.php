  ...
  <div class="header-menu <?php if( get_theme_mod( 'vw_one_page_sticky_header') != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
    <div class="container">
            ...
            <?php $blog_info = get_bloginfo( 'name' ); ?>
              <?php if ( ! empty( $blog_info ) ) : ?>
                <?php if ( is_front_page() && is_home() ) : ?>
                  <?php if( get_theme_mod('vw_one_page_logo_title_hide_show',true) != ''){ ?>
              ...
              ?>
              <?php if( get_theme_mod('vw_one_page_tagline_hide_show',true) != ''){ ?>
        ...
        <?php if ( 'Disable' != $vw_one_page_search_hide_show ) {?>
          <div class="col-lg-1 col-md-2 col-6">
            <div class="search-box">
              <a href="#" onclick="vw_one_page_search_open()"><span><i class="fas fa-search"></i></span></a>
            </div>
          </div>
        <?php } ?>
      </div>
      <div class="serach_outer">
        ...
        <a href="#main" onclick="vw_one_page_search_close()" class="closepop"><i class="fa fa-window-close"></i></a>
      </div>
    </div>
  </div>
</div>